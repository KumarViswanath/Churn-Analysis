...
def load_data(filepath):
    ...
    """
    df = pd.read_csv('C:/Users/rames/OneDrive/Desktop/week_5vev/new_churn_data.csv', index_col='customerID')
    return df


def make_predictions(df, threshold=0.63):
    """
...
if __name__ == "__main__":
    df = load_data('C:/Users/rames/OneDrive/Desktop/week_5vev/new_churn_data.csv')
